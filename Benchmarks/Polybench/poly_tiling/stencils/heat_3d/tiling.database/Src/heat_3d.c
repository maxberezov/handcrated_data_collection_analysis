...
#pragma scop
   ...
   for(i = 1; i <= n-1-1; i += 1)
      for(j_t = 0; j_t <= ((((3*n+5)/32)<(((n-3)/16))) ? ((3*n+5)/32): (((n-3)/16))); j_t += 1)
         for(k_t = (((-2*j_t-2)>(((((16*j_t-n+3)/8)>(((-n+3)/16))) ? ((16*j_t-n+3)/8): (((-n+3)/16))))) ? (-2*j_t-2): (((((16*j_t-n+3)/8)>(((-n+3)/16))) ? ((16*j_t-n+3)/8): (((-n+3)/16))))); k_t <= (((2*j_t+1)<(((((-16*j_t+n-3)/8)<(((n-3)/16))) ? ((-16*j_t+n-3)/8): (((n-3)/16))))) ? (2*j_t+1): (((((-16*j_t+n-3)/8)<(((n-3)/16))) ? ((-16*j_t+n-3)/8): (((n-3)/16))))); k_t += 1)
            for(j_l = (((1)>((((16*j_t+8*k_t+1)>((((32*j_t-n+4)>((16*k_t+1))) ? (32*j_t-n+4): ((16*k_t+1))))) ? (16*j_t+8*k_t+1): ((((32*j_t-n+4)>((16*k_t+1))) ? (32*j_t-n+4): ((16*k_t+1))))))) ? (1): ((((16*j_t+8*k_t+1)>((((32*j_t-n+4)>((16*k_t+1))) ? (32*j_t-n+4): ((16*k_t+1))))) ? (16*j_t+8*k_t+1): ((((32*j_t-n+4)>((16*k_t+1))) ? (32*j_t-n+4): ((16*k_t+1))))))); j_l <= (((16*j_t+8*k_t+24)<((((16*k_t+n+13)<((n-2))) ? (16*k_t+n+13): ((n-2))))) ? (16*j_t+8*k_t+24): ((((16*k_t+n+13)<((n-2))) ? (16*k_t+n+13): ((n-2))))); j_l += 1)
               for(k_l = (((-j_l+32*j_t+2)>((((j_l-16*k_t-15)>((1))) ? (j_l-16*k_t-15): ((1))))) ? (-j_l+32*j_t+2): ((((j_l-16*k_t-15)>((1))) ? (j_l-16*k_t-15): ((1))))); k_l <= (((-j_l+32*j_t+33)<((((j_l-16*k_t)<((n-2))) ? (j_l-16*k_t): ((n-2))))) ? (-j_l+32*j_t+33): ((((j_l-16*k_t)<((n-2))) ? (j_l-16*k_t): ((n-2))))); k_l += 1)
...
int main(int argc, char **argv)
{
   ...
   A = (double (*)[40+0][40+0][40+0]) polybench_alloc_data((40+0)*(40+0)*(40+0), sizeof(double));
   double (*B)[40+0][40+0][40+0];
   B = (double (*)[40+0][40+0][40+0]) polybench_alloc_data((40+0)*(40+0)*(40+0), sizeof(double));
