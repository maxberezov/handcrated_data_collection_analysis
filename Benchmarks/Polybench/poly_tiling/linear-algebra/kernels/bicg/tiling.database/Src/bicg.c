...
int main(int argc, char **argv)
{
   ...
   A = (double (*)[2200+0][1800+0]) polybench_alloc_data((2200+0)*(1800+0), sizeof(double));
   double (*s)[1800+0];
   s = (double (*)[1800+0]) polybench_alloc_data(1800+0, sizeof(double));
   double (*q)[2200+0];
   q = (double (*)[2200+0]) polybench_alloc_data(2200+0, sizeof(double));
   double (*p)[1800+0];
   p = (double (*)[1800+0]) polybench_alloc_data(1800+0, sizeof(double));
   double (*r)[2200+0];
   r = (double (*)[2200+0]) polybench_alloc_data(2200+0, sizeof(double));
   
   /* Initialize array(s). */
   init_array(m, n, *A, *r, *p, *s, *q);
